export const pdfSizePages = [
  ...
  { slug: '150kb', size: '150KB' },
  { slug: '200kb', size: '200KB' },
  { slug: '300kb', size: '300KB' },
  { slug: '400kb', size: '400KB' },
  { slug: '500kb', size: '500KB' },
  { slug: '800kb', size: '800KB' },
  { slug: '1mb', size: '1MB' },
  { slug: '2mb', size: '2MB' },
  { slug: '5mb', size: '5MB' },
  { slug: '10mb', size: '10MB' }
...
export const imageResizePages = [
  ...
  { slug: '300x250', width: 300, height: 250, label: '300x250 (Medium Rectangle Ad)' },
  { slug: '728x90', width: 728, height: 90, label: '728x90 (Leaderboard Ad)' },
  { slug: '160x600', width: 160, height: 600, label: '160x600 (Wide Skyscraper Ad)' },
